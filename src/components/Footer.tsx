        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="/recipes" className="hover:text-primary transition-colors">Công thức</a></li>
              <li><a href="/locations" className="hover:text-primary transition-colors">Món ngon quanh ta</a></li>
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Made with <Heart className="inline h-4 w-4 text-primary fill-primary" /> by Souzy Team
            </p>
          </div>
        </div>
